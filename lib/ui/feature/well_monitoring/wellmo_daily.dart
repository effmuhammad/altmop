...
import 'package:altmop/ui/pdf_report/well_monitoring/pdf_wellmo_daily.dart';
import 'package:widgets_to_image/widgets_to_image.dart';

class ChartData {
  ChartData(this.dateData, this.grossProdData, this.pressureData,
...
class DailyProd extends StatefulWidget {
  final WellSelected wellsel;
  const DailyProd({super.key, required this.wellsel});

  @override
  State<DailyProd> createState() => _DailyProdState();
}

class _DailyProdState extends State<DailyProd> {
    ...
    return Container(
      ...
      child: Table(
        ...
        children: [
          ...
          for (var data in widget.wellsel.getDData)
            TableRow(
              children: [
                rowContent('${data[0]}'),
                rowContent('${data[1]}'),
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    widget.wellsel.getDData.isEmpty
                        ? Padding(
                            padding: const EdgeInsets.all(20),
                            child: Center(
                              child: Column(
                          ...
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) => PdfPreviewPage(
                                pdfBytes: pdfBytes,
                                reportTitle: 'Well Monitoring Daily',
                              ),
                            ),
                          );
                        },
